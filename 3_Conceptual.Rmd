...
fig.milestones <- ggplot() +
  ...
  theme(text = element_text(family = "Georgia"),
        ...
        prism.ticks.length.x = unit(3, "pt"),
...
drivers <- data.frame(
  ...
  driver=as.factor(c("Loss of Indigenous fire through colonization", "Timber management","Fire suppression paradigm","WUI & communities", "Climate change")))
...
fig.drivers <- ggplot() +
  ...
  geom_rect(data=future.drivers, aes(xmin = start, xmax = end, 
              ymin = lower, ymax = upper),
            col = "gray50", fill = "white", size=0.75, alpha=0.6, linetype="dotted") +
  ...
  scale_color_manual(values=c("firebrick4","darkorange3","darkgoldenrod")) +
  #text labels
...
```{r}
fig.timeline2 <- ggarrange(fig.desc,fig.drivers,fig.milestones,
          nrow=3, common.legend=TRUE, legend = "top")
fig.timeline2

ggsave("figures/3_timeline2.png", fig.timeline2, dpi=300, width=10, height=10)
```
...
C [label = 'Mild 20th\n century climate']
D [label = 'Loss of Indigenous fire\n through colonization']
...
digraph boxes_and_circles {
  ...
  # several 'node' statements
  node [shape = box, fontname = Georgia]
...
```
Through my doctoral research I will identify and quantify the drivers, interactions, and feedbacks that characterize disrupted fire regimes. 
